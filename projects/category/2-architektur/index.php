...
<title>Projects - <?php echo $_GET['id']?> - Planquadrat</title>
...
<body>
<div class="navigation__mobile hidden-sm hidden-md hidden-lg"><nav class="navigation"><form action="http://www.planquadrat.com/en/suche/" class="navigation--search-form"><input type="search" name="tx_vierwdindexedsearch_pi2[search][sword]" required placeholder="Search"><button type="submit">Search</button></form><a class="navigation--close">×</a><div class="navigation--row"><ul class="navigation--main page-container"><li><a href="../../../index.html" class="navigation--main-link">Start</a></li><li><a href="../../../profile/index.html" class="navigation--main-link">Profile</a></li><li><a href="../../index.html" class="navigation--main-link active">Projects</a><ul class="navigation--mobile-submenu visible-xs"><li><a href="index.php?id=consultation" class="navigation--main-link">Consultation</a></li><li><a href="index.php?id=Architecture" class="navigation--main-link active">Architecture</a></li><li><a href="index.php?id=Residential" class="navigation--main-link">Residential</a></li>

	<li><a href="index.php?id=UrbanPlanning" class="navigation--main-link">Urban Planning</a></li><li><a href="index.php?id=CompetitionManagement" class="navigation--main-link">Competition Management</a></li><nav class="language-navigation"><ul><li><a href="http://www.planquadrat.com/projects/">DE</a></li><li><a href="../../index.html" class="active">EN</a></li></ul></nav></ul></li>
<li><a href="../../../people/index.html" class="navigation--main-link">People</a></li><li><a href="../../../pin-board/news/index.html" class="navigation--main-link">Pin board</a></li><nav class="language-navigation"><ul><li><a href="http://www.planquadrat.com/projects/">DE</a></li><li><a href="../../index.html" class="active">EN</a></li></ul></nav></ul></div></nav></div>


<header class="main-header"><div class="page-container logo-container"><a href="../../../index.html#showIntro" class="logo"><img src="../../../img/logo.png" alt="Planquadrat"></a></div><a class="navigation--toggle">Menü</a><nav class="navigation"><form action="http://www.planquadrat.com/en/suche/" class="navigation--search-form"><input type="search" name="tx_vierwdindexedsearch_pi2[search][sword]" required placeholder="Search"><button type="submit">Search</button></form><a href="#" class="navigation--close">×</a><div class="navigation--row"><ul class="navigation--main page-container"><li><a href="../../../index.php" class="navigation--main-link">Start</a></li><li><a href="../../../profile/index.php" class="navigation--main-link">Profile</a></li><li><a href="../../index.php" class="navigation--main-link active">Projects</a><ul class="navigation--mobile-submenu visible-xs"><li><a href="../66-beratung/index.html" class="navigation--main-link">Beratung</a></li><li><a href="../6-wettbewerbe/index.html" class="navigation--main-link">Wettbewer</a></li><li><a href="index.html" class="navigation--main-link active">Architecture</a></li><li><a href="../4-generalplanung/index.html" class="navigation--main-link">General Planning</a></li><li><a href="../3-stadtplanung/index.html" class="navigation--main-link">Urban Planning</a></li><li><a href="../68-wettbewerbsmanagement/index.html" class="navigation--main-link">Competition Management</a></li><nav class="language-navigation"><ul><li><a href="http://www.planquadrat.com/projekte/">DE</a></li><li><a href="../../index.php class="active">EN</a></li></ul></nav></ul></li><li><a href="../../../people/index.php" class="navigation--main-link">People</a></li><li><a href="../../../pin-board/news/index.php" class="navigation--main-link">Pin board</a></li><nav class="language-navigation"><ul><li><a href="http://www.planquadrat.com/projects/">DE</a></li><li><a href="../../index.php" class="active">EN</a></li></ul></nav></ul></div><div class="navigation--row hidden-xs"><ul class="navigation--submenu page-container"><li><a href="../../index.html#project-typology" class="navigation--filter-toggle navigation--filter-toggle__active">Typologie<svg xmlns="http://www.w3.org/2000/svg" version="1.1" preserveAspectRatio="none" viewBox="0 0 51 20">
	...
	<polyline points="2,2 26,17 49,2"></polyline>
</svg></a></li><li class="navigation--instant-search"><input type="text" name="project-name" placeholder="Search"></li></ul></div><div class="navigation--filter hidden-xs"><ul class="page-container navigation--filter-container" id="project-typology"><li class="navigation--filter-level1"><a href="index.php?id=consultation">CONSULTATION</a></li><li class="navigation--filter-level1"><a class="active" href="index.php?id=Architecture">Architecture</a><ul><li><a href="index.php?id=Residential">Residential</a></li><li><a href="index.php?id=Commercial">Commercial</a></li><li><a href="index.php?id=Education">Education</a></li><li><a href="index.php?id=Hotel">Hotel</a></li><li><a href="index.php?id=Industrial">Industrial</a></li><li><a href="index.php?id=SpecialConstructions">Special Constructions</a></li></ul></li><li class="navigation--filter-level1"><a href="index.php?id=UrbanPlanning">Urban Planning</a><ul><li><a href="index.php?id=DevelopmentPlan">Development Plan</a></li><li><a href="index.php?id=FrameworkPlanning">Framework Planning</a></li><li><a href="index.php?id=UrbanDevelopment">Urban Development</a></li><li><a href="index.php?id=Studies">Studies</a></li></ul></li><li class="navigation--filter-level1"><a href="index.php?id=CompetitionManagement">Competition Management</a></li></ul></div><div class="navigation--filter hidden-xs"><ul class="page-container navigation--filter-container" id="project-locality"><li class="navigation--filter-level1"><a href="locality/64/index.html">Germany</a></li><li class="navigation--filter-level1"><a href="locality/65/index.html">International</a></li></ul></div></nav></header>
